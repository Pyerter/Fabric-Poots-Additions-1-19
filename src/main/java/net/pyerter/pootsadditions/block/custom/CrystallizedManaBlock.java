...
import net.pyerter.pootsadditions.particle.ModParticleUtil;
import net.pyerter.pootsadditions.particle.ModParticles;

import java.util.List;

public class CrystallizedManaBlock extends TransparentBlock {
    public CrystallizedManaBlock(Settings settings) {
        super(settings);
    }
