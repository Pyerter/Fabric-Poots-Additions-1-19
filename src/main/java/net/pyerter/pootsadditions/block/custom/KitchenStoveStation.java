...
import net.pyerter.pootsadditions.block.entity.KitchenStoveStationEntity;
import net.pyerter.pootsadditions.block.entity.ModBlockEntities;
import org.jetbrains.annotations.Nullable;

public class KitchenStoveStation extends BlockWithEntity implements BlockEntityProvider {
    ...
    public KitchenStoveStation(Settings settings) {
        super(settings);
