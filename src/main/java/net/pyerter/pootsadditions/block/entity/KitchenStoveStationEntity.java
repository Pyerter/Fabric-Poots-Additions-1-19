...
import net.pyerter.pootsadditions.recipe.KitchenStoveRecipe;
...
public class KitchenStoveStationEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public static void tick(World world, BlockPos pos, BlockState state, KitchenStoveStationEntity entity) {
        ...
        if (KitchenStoveStation.getOvenLit(entity.getCachedState()) != shouldLightOven) {
            KitchenStoveStation.setOvenLit(entity.getCachedState(), entity.world, entity.pos, shouldLightOven);
        }
        if (KitchenStoveStation.getStoveLit(entity.getCachedState()) != shouldLightStove) {
            KitchenStoveStation.setStoveLit(entity.getCachedState(), entity.world, entity.pos, shouldLightStove);
        }
    }
