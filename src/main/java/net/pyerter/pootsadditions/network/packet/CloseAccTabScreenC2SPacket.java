...
public class CloseAccTabScreenC2SPacket implements Packet<ServerPlayPacketListener> {
    private final int syncId;
    private final ScreenHandlerType<?> screenHandlerId;
    private final Text name;


    public CloseAccTabScreenC2SPacket(int syncId, ScreenHandlerType<?> type, Text name) {
        this.syncId = syncId;
        this.screenHandlerId = type;
        this.name = name;
    }

    public CloseAccTabScreenC2SPacket(PacketByteBuf buf) {
    ...
    public void apply(ServerPlayPacketListener listener) {
        ((IAccTabScreenHandlerOpener)listener).onCloseAccTabScreen(this);
    }
