...
public class FoodPreppingStationRecipe implements Recipe<SimpleInventory> {
    ...
    public boolean matches(SimpleInventory inventory, World world) {
        ...
        if (ingredients.size() > 6) {
            PootsAdditions.logDebug("Error while crafting FoodPreppingStationRecipe - ingredients list too large for recipe ID " + id);
            return false;
        }
    ...
    public static class Serializer implements RecipeSerializer<FoodPreppingStationRecipe> {
        ...
        public FoodPreppingStationRecipe read(Identifier id, JsonObject json) {
            ...
            try {
                ...
                PootsAdditions.logDebug("Json syntax exception while reading recipe " + ID + ", assuming empty stack for left_layer_ingredient: " + id.toString());
            }
            ...
            try {
                ...
                PootsAdditions.logDebug("Json syntax exception while reading recipe " + ID + ", assuming empty stack for right_layer_ingredient: " + id.toString());
            }
            ...
            try {
                ...
                PootsAdditions.logDebug("Json syntax exception while reading recipe " + ID + ", assuming empty stack for tool_ingredient: " + id.toString());
            }
