...
import net.pyerter.pootsadditions.screen.handlers.FoodPreppingStationScreenHandler;
...
public class FoodPreppingStationScreen extends HandledScreen<FoodPreppingStationScreenHandler> {
    ...
    private static final Identifier TEXTURE =
            new Identifier(PootsAdditions.MOD_ID, "textures/gui/food_prepping_station_gui.png");
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (bowlClicked) {
            PootsAdditions.logInfo("Clicking prep!");
